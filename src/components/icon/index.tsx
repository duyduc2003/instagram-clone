export const IconInstagramText = () => (
  <svg
...
export const IconPlusSquareFill = () => (
  <svg
    aria-label="New post"
    color="inherit"
    fill="currentColor"
...
export const IconLoading = () => (
  <svg aria-label="Loading..." className="icon-loading" viewBox="0 0 100 100">
    <rect
      fill="rgb(85, 85, 85)"
      height="10"
      opacity="0"
